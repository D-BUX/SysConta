...
<body>
								...
								<div class="row">
									<form class="col s12">
										...
										<div class="row">
											<div class="col s12 m12 l12">
												<div class="input-field col s6">
													<input id="txtDate1" type="date" class="datepicker"> <label
														for="password">Inicio</label>
												</div>
												<div class="input-field col s6">
													<input id="txtDate2" type="date" class="datepicker"> <label
														for="password">Fin</label>
												</div>
											</div>
	...
	<script type="text/javascript">
		...
		$(function () {
			$('#txtDate1').datepicker();
			  $('#txtDate1').datepicker('option', { dateFormat: 'yyyy-mm-dd' });
			});
